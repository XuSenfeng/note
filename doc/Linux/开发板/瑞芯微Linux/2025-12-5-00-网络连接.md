...
> 这个项目软件代码编译[[2025-12-5-02-EchoAI代码原理]], 原理在[[2025-12-5-02-EchoAI代码原理]]
> 系统相关的可以查看[[2025-12-7-03-编译脚本]]
> 使用的设备配置[[2025-12-8-04-驱动]]
> 模型对接在[[2025-12-9-05-AI模型对接]]
> 代码里面的C和C++相互引用原理在[[2025-12-10-Cpp提供C接口]]
