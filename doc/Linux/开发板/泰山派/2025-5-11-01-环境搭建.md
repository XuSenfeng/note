...
> 编译以后连接不同的设备需要使用[[2022-8-27-38-设备树]]
> 实际的应用示例是[[2025-5-14-03-屏幕驱动]]和[[2025-5-17-04-触摸驱动]]
> 图形界面可以使用[[2025-12-20-05-lvgl程序]]以及[[2025-12-26-10-Qt]]
> 部署模型以及视觉使用[[2025-12-24-07-yolo部署]]和[[2025-12-25-08-OpenCV]], 基于[[2025-12-26-09-拍照]]
> 尝试自己编译[[2026-1-27-27-ROS]], 后来还是使用[[2026-1-30-28-Ubuntu22]]移植以后安装
