...
![Screenshot_20230908_100954_com.xiaoe.client](E:\a学习\笔记\img\Screenshot_20230908_100954_com.xiaoe.client.png)

BIOS会检查硬盘的第一个扇区的最后两个字节如果是上面的两个数据, 就会进行拷贝, 之后进行执行, 拷贝到0x7c00位置, os.bin文件会通过dd命令写入disk.img文件的开头

![image-20230908102628762](E:\a学习\笔记\img\image-20230908102628762.png)
...
![image-20230908103332365](E:\a学习\笔记\img\image-20230908103332365.png)

> 识别成功

![image-20230908103606213](E:\a学习\笔记\img\image-20230908103606213.png)
...
![Screenshot_20230908_104010_com.xiaoe.client](E:\a学习\笔记\img\Screenshot_20230908_104010_com.xiaoe.client.png)

> 可以利用不同的名字对各个寄存器的不同位置进行操作

+ 段寄存器

![Screenshot_20230908_104329_com.xiaoe.client](E:\a学习\笔记\img\Screenshot_20230908_104329_com.xiaoe.client.png)

早期的十六位CPU访问的范围比较小, 所以设置一个起始位置, 之后在上面进行叠加访问

![Screenshot_20230908_104618_com.xiaoe.client](E:\a学习\笔记\img\Screenshot_20230908_104618_com.xiaoe.client.png)
...
![image-20230908123951948](E:\a学习\笔记\img\image-20230908123951948.png)
...
![image-20230908193552168](E:\a学习\笔记\img\image-20230908193552168.png)

![image-20230908193533914](E:\a学习\笔记\img\image-20230908193533914.png)
...
![image-20230911165013102](E:\a学习\笔记\img\image-20230911165013102.png)
...
![image-20230911213220046](E:\a学习\笔记\img\image-20230911213220046.png)

![image-20230911213417535](E:\a学习\笔记\img\image-20230911213417535.png)

> 使用命令`info registers`

![image-20230911213826872](E:\a学习\笔记\img\image-20230911213826872.png)
...
![image-20230912091325312](E:\a学习\笔记\img\image-20230912091325312.png)
...
![image-20230912100752988](E:\a学习\笔记\img\image-20230912100752988.png)

![image-20230912100916065](E:\a学习\笔记\img\image-20230912100916065.png)
...
![image-20230912144435370](E:\a学习\笔记\img\image-20230912144435370.png)

![image-20230912144527920](E:\a学习\笔记\img\image-20230912144527920.png)
...
![image-20230913092705738](E:\a学习\笔记\img\image-20230913092705738.png)
...
![image-20230913093734029](E:\a学习\笔记\img\image-20230913093734029.png)
...
![image.png](E:\a学习\笔记\img\1662696028446-2755631d-924b-4aa6-aa7e-ffda200732da.png)
...
![image.png](E:\a学习\笔记\img\1662697905346-16e0d5d8-4301-4d4d-b71b-f7c0e5f1863a.png)

这里相当于从一个中断函数进行返回, 在进入中断的时候会自动保存上面右侧显示的寄存器内容, SS栈的段寄存器, ESP栈的指针, CS代码段, EIP指令对应的地址, 返回的时候会自动设置这些值

![image-20230920130514065](E:\a学习\笔记\img\image-20230920130514065.png)
...
![img](E:\a学习\笔记\img\`5`RK7`$FV%WT0IH8[Y27XU.png)

> 进入特权级3的模式

+ 之后需要给这一个特权级的任务定义一个数组作为栈

![image-20230920230330223](E:\a学习\笔记\img\image-20230920230330223.png)
...
![image.png](E:\a学习\笔记\img\1662704435939-b1962e6c-aa16-4b9e-8a0a-5c46eb5c1f76.png)

> 这里面存放的是当前任务的状态, CPU会自动把寄存器的状态存放在这里面, 这里面的SS, ESP等有多个是给不同特权级的时候使用不同的段

![image-20230920232807856](E:\a学习\笔记\img\image-20230920232807856-16952237081793.png)

> 在产生中断的时候会从特权级0的位置找到栈, 之后执行中断相关的内容

![image-20230921083651573](E:\a学习\笔记\img\image-20230921083651573.png)

需要在GDT里面使用两个段来记录两个任务的TSS, 通过GDT的描述符进行区分

![image.png](E:\a学习\笔记\img\1662704519159-23b389c6-fcc3-44dd-98fb-562b33140a52.png)
...
![image-20230921100950824](E:\a学习\笔记\img\image-20230921100950824.png)

> 跳转之前的任务1

![image-20230921101039232](E:\a学习\笔记\img\image-20230921101039232.png)

![image-20230921101421193](E:\a学习\笔记\img\image-20230921101421193.png)

> 跳转之后, 有一些寄存器会发生自动的更改, 这时候的段寄存器发生了变化, 由于是在中断中发生的

![image-20230921101010695](E:\a学习\笔记\img\image-20230921101010695.png)

> 这是任务1没有开始执行的时候的数据

![image-20230921101832319](E:\a学习\笔记\img\image-20230921101832319.png)
...
![image.png](E:\a学习\笔记\img\1662705648328-e5b182a9-a105-4c0c-9e7b-e832c5a93039.png)
...
> 显示一个字符
>
> ![image-20230921161254909](E:\a学习\笔记\img\image-20230921161254909.png)
>
> 有80列25行

![image-20230921165941136](E:\a学习\笔记\img\image-20230921165941136.png)
...
![image-20230922142341114](E:\a学习\笔记\img\image-20230922142341114.png)

> CS和DS使用相同的值但是访问的内存的位置是不同的

![image-20230922142400371](E:\a学习\笔记\img\image-20230922142400371.png)
