...
![image-20230914120258792](E:\a学习\笔记\img\image-20230914120258792.png)

![image-20230914120315929](E:\a学习\笔记\img\image-20230914120315929.png)
...
![image-20230914120741160](E:\a学习\笔记\img\image-20230914120741160.png)
...
![image-20230914122808760](E:\a学习\笔记\img\image-20230914122808760.png)

> HREF在高位的时候传输的数据是有效的, 这个是在每一行进行一次跳变, 在时钟每一次高电平的时候进行数据的采样, 低电平的时候会进行改变

![image-20230914123046234](E:\a学习\笔记\img\image-20230914123046234.png)
...
![image-20230914192931248](E:\a学习\笔记\img\image-20230914192931248.png)

![image-20230914192943344](E:\a学习\笔记\img\image-20230914192943344.png)

![image-20230914194003346](E:\a学习\笔记\img\image-20230914194003346.png)
...
![image-20230914195042494](E:\a学习\笔记\img\image-20230914195042494.png)

![image-20230914195107623](E:\a学习\笔记\img\image-20230914195107623.png)

> WEN是一个普通的GPIO进行控制的引脚, 只有在数据有效以及WEN使能的时候才会使能FIFO的写入功能

![image-20230914195356040](E:\a学习\笔记\img\image-20230914195356040.png)

## 实际上的软件实现

在这里使用的GPIO视同一组的GPIO, 所以可以直接读取GPIO_IDR寄存器进行获取读取到的状态

![image-20230914225329956](E:\a学习\笔记\img\image-20230914225329956.png)
