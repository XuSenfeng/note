...
![image-20230628180451294](E:\a学习\笔记\img\image-20230628180451294.png)

![image-20230628180512907](E:\a学习\笔记\img\image-20230628180512907.png)
...
优先级还会进行分组, 设置为五个组, 控制寄存器表示的方法(主优先级和子优先级分别由几位进行控制), 使用寄存器SCB->AIRCR:PRIGROUP[10:8]\(系统控制块(System Control Block))

![image-20230628183435658](E:\a学习\笔记\img\image-20230628183435658.png)
...
EXTI(外部中断/事件控制器)控制, 对应的是上面的中断函数中的EXTI触发的中断
...
![image-20230628193325234](E:\a学习\笔记\img\image-20230628193325234.png)

![image-20230628193616469](E:\a学习\笔记\img\image-20230628193616469.png)
...
>
>   ![image-20230628200901595](E:\a学习\笔记\img\image-20230628200901595.png)

![image-20230628194547668](E:\a学习\笔记\img\image-20230628194547668.png)

>   第19根这个版本没有

![image-20230628195224413](E:\a学习\笔记\img\image-20230628195224413.png)

>   AFIO_EXTICR1等寄存器控制实际的对应的I/O

+   EXTI_RTSR上升沿触发选择

![image-20230628195445820](E:\a学习\笔记\img\image-20230628195445820.png)

+   EXTI_FTSR下降沿触发

![image-20230628195511517](E:\a学习\笔记\img\image-20230628195511517.png)
...
![image-20230630154013370](E:\a学习\笔记\img\image-20230630154013370.png)
