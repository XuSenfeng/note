...
1.   输入电压VREF-<=VIM<=VREF+, 设置电压的引脚, 还有VDDA, 模拟电压的电源, VSSA模拟的地, 这里链接的是3.3V和地![image-20230715104441085](https://picture-01-1316374204.cos.ap-beijing.myqcloud.com/image/202310281059571.png)
